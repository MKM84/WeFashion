    ...
    <div class="row">
                ...
                <div class="form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="description"
                            class="form-control" placeholder="Description du produit">{{ old('description') }}</textarea>
        ...
        <div class="col-md-6">
            ...
            <div class="input-radio">
                <h2>Status</h2>
                <input type="radio" @if (old('status')=='sold' ) checked @endif name="status" value="sold"
                    checked> En soldes<br>
                <input type="radio" @if (old('status')=='satandard' ) checked @endif name="status"
                    value="satandard"> Satandard<br>
            </div>
            <div class="input-radio">
                <h2>Visibilité</h2>
            ...
            <div class="input-radio">
                <h2>Taille</h2>
                <input type="radio" @if (old('size')=='XL' ) checked @endif name="size" value="XL"
                    checked> XL<br>
                    <input type="radio" @if (old('size')=='L' ) checked @endif name="size" value="L"
                    checked> L<br>
                    <input type="radio" @if (old('size')=='M' ) checked @endif name="size" value="M"
                    checked> M<br>
                    <input type="radio" @if (old('size')=='S' ) checked @endif name="size" value="S"
                    checked> S<br>
                    <input type="radio" @if (old('size')=='XS' ) checked @endif name="size" value="XS"
                    checked> XS<br>
